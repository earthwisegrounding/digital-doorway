...
(() => {
  ...
  $('#launch').addEventListener('click', () => {
    if (matchMedia('(max-width: 600px)').matches) { location.href = 'https://earthwisegrounding.github.io/verdura/prolawn/b/designer.html'; return; }
    embed.classList.add('loading');
    const f = document.createElement('iframe');
    f.src = 'https://earthwisegrounding.github.io/verdura/prolawn/b/designer.html';
